...
do
	...
	curl -s "http://www.city.poznan.pl/mapa_geopoz/data/ulice_adresy/geopoz-ulice.php?poczatek=$p" | iconv -f iso-8859-2 -t utf-8 | grep -E "\s<td id" | sed -E "s/.*>([^<]+)<.*/\\1/" >> geopoz.tmp
done
